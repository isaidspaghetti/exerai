...
UNSPLASH_ACCESS_KEY = "YOUR_UNSPLASH_ACCESS_KEY"  # You'll need to get this from Unsplash
UNSPLASH_API_URL = "https://api.unsplash.com/search/photos"

# Exercise-specific search terms for better results
...
def search_unsplash(query):
    """Search Unsplash for images based on query"""
    params = {
        'query': query,
    ...
    try:
        ...
        if data['results']:
            ...
            return f"https://images.unsplash.com/photo-{image['id']}?w=400&h=300&fit=crop"
        else:
            return None
...
def main():
    print("Searching Unsplash for exercise images...")
    print("Note: You'll need to add your Unsplash API key to use this script.")
    ...
    with open('exercise_image_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    print(f"\nResults saved to exercise_image_results.json")
